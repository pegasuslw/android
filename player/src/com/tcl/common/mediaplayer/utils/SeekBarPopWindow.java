...
//	    popupWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, xoff-textView.getWidth()/2+Utils.SeekBarThumbLength/2, yoff);
//		popupWindow.showPopUp(anchor);
//		int[] location = new int[2];  
		anchor.getLocationOnScreen(location);       
        popupWindow.showAtLocation(anchor, Gravity.NO_GRAVITY, location[0] + xoff-textView.getWidth()/2+Utils.SeekBarThumbLength/2, location[1]-popupWindow.getHeight() + yoff - 20);  

	    Utils.printLog("SeekBarPopWindow", "postDelayed DISMISS_TIME="+DISMISS_TIME);
