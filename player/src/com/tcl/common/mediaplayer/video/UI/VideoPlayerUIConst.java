...
//    public static final String COLLECTION_APP_MODE = "com.tcl.sis.onlinevideo.app_mode";//收藏媒体类型参数字符串；
  ...
  //图效模式
  	...
  	public static int PM_STANDARD = 1;
  	public static int PM_USER = 2;
  	public static int PM_STUDIO = 3;
  	public static int PM_VIVID = 4;
  	public static int PM_MILD = 5;
  	
  	//音效模式

  	
  	public static int SM_STANDARD = 1;
  	public static int SM_NEWS = 2;
  	public static int SM_MOVIE = 3;
  	public static int SM_MUSIC = 4;

  	//画面比例  EnTCLAspectRatio.EN_TCL_16X9; EnTCLAspectRatio.EN_TCL_4X3; EnTCLAspectRatio.EN_TCL_AUTO;
  	
  	public static int PS_16x9 = 1;
  	public static int PS_4X3 =2;
  	public static int PS_AUTO = 3;
