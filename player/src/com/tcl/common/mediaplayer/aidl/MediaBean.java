...
public class MediaBean implements Parcelable {
	...
	/******************************for xiangling ******************************************************/
    public String mMusicPosterImagePath;//专辑封面地址
    public String mSongsterName;//歌手名字
    public String mPoster; //所属专辑
    public String mGenre;//流派
    public long mMediaId;//本地电影海报索引
    
    public String mFileName;//显示的名字
//	public String mSinger;//歌手
	public Bitmap mAlbum;//专辑封面
//	public String mAlbumPath;//专辑封面地址
	public String mDuration;//总时长；
...
//            bean.mFileName = source.readString();
//            bean.mSinger = source.readString();
//            bean.mAlbumPath = source.readString();
//            bean.mDuration = source.readString();
//            bean.mAlbum = source.readParcelable(new ClassLoader() {
//			});
...
//        dest.writeString(this.mAlbumPath);
