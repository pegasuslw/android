...
public enum MAPI_VIDEO_ARC_Type implements Parcelable
{
	...
	public static final Parcelable.Creator<MAPI_VIDEO_ARC_Type> CREATOR = new Parcelable.Creator<MAPI_VIDEO_ARC_Type>()
	{
		public MAPI_VIDEO_ARC_Type createFromParcel(Parcel in)
		{
			return MAPI_VIDEO_ARC_Type.values()[in.readInt()];
		}

		public MAPI_VIDEO_ARC_Type[] newArray(int size)
		{
			return new MAPI_VIDEO_ARC_Type[size];
		}
	};
