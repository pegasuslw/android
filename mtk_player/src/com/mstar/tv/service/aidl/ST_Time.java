 ...
 *
 */
public class ST_Time extends Time implements Parcelable
{
	
	public static final Parcelable.Creator<ST_Time> CREATOR = new Parcelable.Creator<ST_Time>()
	{
		public ST_Time createFromParcel(Parcel in)
		{
			return new ST_Time(in);
		}

		public ST_Time[] newArray(int size)
		{
			return new ST_Time[size];
		}
	};
	...
	public ST_Time(int year, int month, int day, int hour, int min,
			int sec)
	{
		super();
		this.year = year;
    ...
    public void writeToParcel(Parcel arg0, int arg1)
    {
		arg0.writeInt(year);
		arg0.writeInt(month);
		arg0.writeInt(monthDay);
		arg0.writeInt(hour);
		arg0.writeInt(minute);
