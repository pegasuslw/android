...
public class ST_OnTime_TVDes implements Parcelable
{
	...
	public static final Parcelable.Creator<ST_OnTime_TVDes> CREATOR = new Parcelable.Creator<ST_OnTime_TVDes>()
	{
		public ST_OnTime_TVDes createFromParcel(Parcel in)
		{
			return new ST_OnTime_TVDes(in);
		}

		public ST_OnTime_TVDes[] newArray(int size)
		{
			return new ST_OnTime_TVDes[size];
		}
	};
    
	public ST_OnTime_TVDes(EN_TIME_ON_TIME_SOURCE eSource, int ch, short i)
	{
    ...
    private ST_OnTime_TVDes(Parcel in) 
    { 
    	enTVSrc = EN_TIME_ON_TIME_SOURCE.values()[in.readInt()];   
    	mChNo = in.readInt(); 
    	mVol = (short)in.readInt(); 
    }
