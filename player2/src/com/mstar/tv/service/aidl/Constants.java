...
{
	/*Tv service connection message definition*/
	public static final int CONNECTION_OK = 2147483647; //max int to avoid collision
	...
	/*Error definition of skin function execution */
	public static final int CONNECTION_WRONG = -1;
	public static final int REMOTE_EXEC_ERROR= -2;
	
	/*timer broadcast type*/
	final int TIME_EVENT_SHOW_TARGET_COUNTER_DOWN  = 0x01;
	final int TIME_EVENT_SHOW_OFF_COUNTER_DOWN  = 0x02;
	final int TIME_EVENT_SHOW_EXECUTE_TO_TARGET  = 0x03;
	final int TIME_EVENT_SHOW_POWER_OFF = 0x04;
}