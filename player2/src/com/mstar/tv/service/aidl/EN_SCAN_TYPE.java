...
public enum EN_SCAN_TYPE implements Parcelable
{
	...
	public static final Parcelable.Creator<EN_SCAN_TYPE> CREATOR = new Parcelable.Creator<EN_SCAN_TYPE>()
	{
		public EN_SCAN_TYPE createFromParcel(Parcel in)
		{
			return EN_SCAN_TYPE.values()[in.readInt()];
		}

		public EN_SCAN_TYPE[] newArray(int size)
		{
			return new EN_SCAN_TYPE[size];
		}
	};
