...
public enum EN_SLEEP_TIME_STATE implements Parcelable
{
	...
	public static final Parcelable.Creator<EN_SLEEP_TIME_STATE> CREATOR = new Parcelable.Creator<EN_SLEEP_TIME_STATE>()
	{
		public EN_SLEEP_TIME_STATE createFromParcel(Parcel in)
		{
			return EN_SLEEP_TIME_STATE.values()[in.readInt()];
		}

		public EN_SLEEP_TIME_STATE[] newArray(int size)
		{
			return new EN_SLEEP_TIME_STATE[size];
		}
	};
