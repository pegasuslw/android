...
public class VIDEO_WINDOW_TYPE implements Parcelable
{
	...
	public static final Parcelable.Creator<VIDEO_WINDOW_TYPE> CREATOR = new Parcelable.Creator<VIDEO_WINDOW_TYPE>()
	{
		public VIDEO_WINDOW_TYPE createFromParcel(Parcel in)
		{
			return new VIDEO_WINDOW_TYPE(in);
		}

		public VIDEO_WINDOW_TYPE[] newArray(int size)
		{
			return new VIDEO_WINDOW_TYPE[size];
		}
	};
    
	public VIDEO_WINDOW_TYPE(int x, int y, int width, int height)
	{
		this.x = x;
		this.y = y;
		this.width = width;
    ...
    private VIDEO_WINDOW_TYPE(Parcel in) 
    { 
		this.x = in.readInt();
		this.y = in.readInt();
