 ...
 * author long.chen
 */
public class BoolArrayList extends ArrayList<Boolean> implements Parcelable
{
	...
	public BoolArrayList(Parcel in)
	{  
	    super();
	...
	public static final Parcelable.Creator<BoolArrayList> CREATOR = new Parcelable.Creator<BoolArrayList>() 
	{     
		public BoolArrayList createFromParcel(Parcel in) 
		{         
			return new BoolArrayList(in);     
		}

		public BoolArrayList[] newArray(int size) {
			// TODO Auto-generated method stub
			return new BoolArrayList[size];
		}      
	};
