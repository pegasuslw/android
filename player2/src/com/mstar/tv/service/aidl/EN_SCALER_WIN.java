...
{
    MAPI_MAIN_WINDOW,
    MAPI_SUB_WINDOW,	//pip window
    MAPI_MAX_WINDOW;

	public static final Parcelable.Creator<EN_SCALER_WIN> CREATOR = new Parcelable.Creator<EN_SCALER_WIN>()
	{
		public EN_SCALER_WIN createFromParcel(Parcel in)
		{
			return EN_SCALER_WIN.values()[in.readInt()];
		}

		public EN_SCALER_WIN[] newArray(int size)
		{
			return new EN_SCALER_WIN[size];
		}
	};
