...
public enum EN_SOUND_MODE implements Parcelable
{
	...
	public static final Parcelable.Creator<EN_SOUND_MODE> CREATOR = new Parcelable.Creator<EN_SOUND_MODE>()
	{
		public EN_SOUND_MODE createFromParcel(Parcel in)
		{
			return EN_SOUND_MODE.values()[in.readInt()];
		}

		public EN_SOUND_MODE[] newArray(int size)
		{
			return new EN_SOUND_MODE[size];
		}
	};
